...
return ( <header className="sticky top-0 z-30 border-b border-[#27231F] bg-[#100E0C]/95 backdrop-blur-xl"> <div className="flex h-[88px] items-center gap-4 px-5 md:px-8"> <form
       onSubmit={handleSearch}
       className="flex min-w-0 flex-1"
     > <div className="flex h-12 w-full max-w-4xl items-center rounded-full border border-[#302C28] bg-[#211E1B] px-4 transition focus-within:border-[#4A4540] focus-within:bg-[#25211E]"> <SearchIcon className="h-5 w-5 shrink-0 text-[#8A8580]" />
      ...
      {isMenuOpen ? (
        ...
        >
          ...
          <button
            ...
            className="mt-1 flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-left text-sm text-[#C9C4BC] transition hover:bg-[#292521] hover:text-[#F4F1EB] disabled:cursor-not-allowed disabled:opacity-50"
          >
